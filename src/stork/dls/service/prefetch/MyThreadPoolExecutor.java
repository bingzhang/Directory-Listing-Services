...
public class MyThreadPoolExecutor extends AbstractExecutorService {
	...
	public void setName(String threadGroupName){
    ...
    private void decrementWorkerCount() {
        do {
        	//System.out.println("try to decrementWorkerCount");
        ...
        implements Runnable
    {
        ...
        Worker(Runnable firstTask) {
            ...
            if(DEBUG_PRINT){
            	System.out.println("threadGroup:\t"+ threadGroupName + "has worker #:\t" + workers.size());
            }
     ...
     * the task is handled by the current {@code MyRejectedExecutionHandler}.
     *
    ...
    public void execute(Runnable command) {
        ...
        int wc = workerCountOf(c);
        if(DEBUG_PRINT){
        	System.out.println(this.threadGroupName +"\tuses "+wc+" worker threads taskQueue size:\t"+ workQueue.size() + "workers set is:\t" + workers.size());
        }
        if (wc < corePoolSize) {
    ...
    public void setCorePoolSize(int corePoolSize) {
        ...
        this.corePoolSize = corePoolSize;
        //shrink the size of workers
        if (workerCountOf(ctl.get()) > corePoolSize){
            interruptIdleWorkers();
        }
        //expand the size of workers
        else{
        	while(true){
        		int c = ctl.get();
        		int wc = workerCountOf(c);
